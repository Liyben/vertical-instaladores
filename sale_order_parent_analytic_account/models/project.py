...
class Project(models.Model):
	...
	parent_analytic_account_id = fields.Many2one('account.analytic.account', string='Línea Negocio', domain=[('type_analytic_account', '=', 'activity')], default=_get_default_parent_analytic_account_id, related='analytic_account_id.parent_id')
	...
	def create(self, vals):
		...
		if project and project.parent_analytic_account_id:
			project.analytic_account_id.parent_id = project.parent_analytic_account_id.id
