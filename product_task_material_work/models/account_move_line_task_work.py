...
class AccountMoveLineTaskWork(models.Model):
	...
	account_move_line_id = fields.Many2one(comodel_name='account.move.line', string='Linea de factura')
	#Mano de obra
