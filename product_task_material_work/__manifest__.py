...
En la vista 'sale.report_invoice_layouted' comentar la etiqueta <xpath expr="//table" position="after">...</xpath>
    """,
    'author': 'Liyben',
    'depends': ['sale', 'project_task_material','sale_timesheet','percent_field',
                'crm_aviso_to_pt','sale_order_invoicing_finished_task','account','lyb_avisos_code',
                'project_task_code','sales_team','account','hr_timesheet','sale_margin','web_tree_many2one_clickable'],
