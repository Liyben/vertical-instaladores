...
class SaleOrder(models.Model):
		...
		for sale in self:
			for line in sale.order_line:
				if line.auto_create_task:
					line.detailed_subtotal_price_time = not sale.detailed_subtotal_price_time
	...
	def print_detailed_subtotal_price_materials(self):
		for sale in self:
			for line in sale.order_line:
				if line.auto_create_task:
					line.detailed_subtotal_price_materials = not sale.detailed_subtotal_price_materials
	...
	def print_detailed_time(self):
		for sale in self:
			for line in sale.order_line:
				if line.auto_create_task:
					line.detailed_time = not sale.detailed_time
	...
	def print_detailed_price_time(self):
		for sale in self:
			for line in sale.order_line:
				if line.auto_create_task:
					line.detailed_price_time = not sale.detailed_price_time
	...
	def print_detailed_materials(self):
		for sale in self:
			for line in sale.order_line:
				if line.auto_create_task:
					line.detailed_materials = not sale.detailed_materials
	...
	def print_detailed_price_materials(self):
		for sale in self:
			for line in sale.order_line:
				if line.auto_create_task:
					line.detailed_price_materials = not sale.detailed_price_materials
